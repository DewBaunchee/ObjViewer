...
class PixelLine(val from: Pixel, val to: Pixel) {
    ...
    fun atY(y: Double): Pixel {
        ...
        return Pixel(
            ...
            from.worldView.plus(stepY.worldView.multiplied(dy)),
    ...
    fun atX(x: Double): Pixel {
        ...
        return Pixel(
            ...
            from.worldView.plus(stepX.worldView.multiplied(dx)),
    ...
    private fun createStep(diff: Double): Pixel {
        return Pixel(
            ...
            to.worldView.minus(from.worldView).multiplied(1.0 / diff),
